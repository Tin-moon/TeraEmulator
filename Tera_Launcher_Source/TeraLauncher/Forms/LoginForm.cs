...
namespace TeraLauncher
{
    public partial class LoginForm : Form
    {
        ...
        public static string _pbox_news_img { get; set; }
        ...
        public LoginForm()
        {
            ...
            _progressLabel.Text = _progressLabel.Text + " " + _totalProgressBar.Value + "%";

            // Turn On Password mode!
            _passwordInputBox.PasswordChar = '*';
            _usernameInputBox.MaxLength = 15;
            _passwordInputBox.MaxLength = 15;
        }
        //main form load
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Incorrect email address or password. Please try again.", "Error");
            }
            else
            if (master_account_name != "" && master_account_password != "")
                {
                    string webStringResponse = getWebStringResponse("http://127.0.0.1/auth/", "POST", "username=" + master_account_name + "&password=" + master_account_password);
        ...
        public void checkconfig()
        {
            ...
            else
            {
                ...
                _pbox_news_img = Config.GetPictureBoxNews();
        ...
        public void setimages()
        {
            ...
            // Chance news picture
            if (_pbox_news_img != null)
            { this._pictureboxNews.Image = Image.FromFile(dataDir + _pbox_news_img); }
