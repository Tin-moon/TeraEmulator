...
namespace Network
{
    public class OpCodes
    {
        ...
        public static void Init()
        {
            ...
            //first empty? packet only added to RpSystemInfo to not get unk.packet message on start
            Recv.Add(unchecked((short) 0xB04C), typeof (RpSystemInfo)); 
            
            // Auth
            Recv.Add(unchecked((short) 0x4DBC), typeof (RpCheckVersion)); //all revs
            //Recv.Add(unchecked((short) 0xEDB0), typeof (RpAuth)); //2113 EU
